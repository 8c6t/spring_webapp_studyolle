...
import com.hachicore.config.AppProperties;
import com.hachicore.domain.Account;
import com.hachicore.domain.Tag;
import com.hachicore.domain.Zone;
import com.hachicore.mail.EmailMessage;
import com.hachicore.mail.EmailService;
...
public class AccountService implements UserDetailsService {
    ...
    public void sendSignUpConfirmEmail(Account newAccount) {
        ...
        context.setVariable("link", "/check-email-token?token=" + newAccount.getEmailCheckToken() + "&mail=" + newAccount.getEmail());
